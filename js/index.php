			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li><a href="ActualizarProd.html">Actualizar productos</a></li>
						<li class="btn-cta"><a href="registrarse.html"><span>Registrarse</span></a></li>
								...
								<div class="tab">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3 class="cursive-font">Tabla de Reservasiones</h3>
											<form action="#">
												<div class="row form-group">
													<div class="col-md-12">
														<label for="activities">Productos</label>
														<select name="#" id="activities" class="form-control">
															<option value="">Prodctos</option>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<label for="date-start">Fecha del pedido</label>
														<input type="text" id="date" class="form-control">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<label for="date-start">Hora de entrega</label>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" class="btn btn-primary btn-block" value="Pedir producto">
													</div>
												</div>
											</form>	
										</div>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Seleccione "Salir" si esta listo para cerrar la sesión actual.</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                    <a class="btn btn-primary" href="files/cerrarSesion.php">Salir</a>
                </div>
            </div>
        </div>
    </div>
				...
				<div class="col-md-12 text-center">
					...
					<div class="gtco-widget">
						...
						<ul class="gtco-social-icons">
							...
							<li><a href="https://www.facebook.com/Expendiobimbochunhuhub/"><i class="icon-facebook"></i></a></li>
							<li><a href="https://api.whatsapp.com/send?phone=+52 9831640520"><i class="icon-phone"></i> +52 9831640520</a></li>
						</ul>
					</div>
				</div>

				<div class="col-md-12 text-center copyright">
					<!-- <p><small class="block">&copy; 2016 Uicab</small>  -->
